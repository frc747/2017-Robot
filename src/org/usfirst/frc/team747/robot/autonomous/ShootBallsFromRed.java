...
//        addSequential(new DriveDistanceCommand(55, -.5));
        ...
        addSequential(new DriveDistanceSimpleCommand(40, -.19)); // was 45
        addSequential(new PauseCommand(.5));
        addSequential(new DriveRotateSimpleCommand(-.50, -35));
        addSequential(new PauseCommand(.5));
        addSequential(new DriveDistanceSimpleCommand(28, .30)); //66
        addSequential(new ShootBallsTimedCommand(4));
        addSequential(new PauseCommand(.5));
        addSequential(new DriveDistanceSimpleCommand(12, -.30));
        addSequential(new PauseCommand(.5));
        addSequential(new DriveRotateSimpleCommand(.50, 35));
        addSequential(new PauseCommand(.5));
        addSequential(new DriveDistanceSimpleCommand(55, -.70));
